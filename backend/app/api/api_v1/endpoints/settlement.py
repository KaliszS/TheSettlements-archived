...
from app.schemas import Settlement, SettlementUpdate
router = APIRouter()
...
async def create_settlement(model_in: Settlement):
...
async def update_settlement(id: str, model_in: SettlementUpdate):
